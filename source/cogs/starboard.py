...
class StarBoard(Cog):
    ...
    @slash_subcommand(base="starboard", name="limit", description="Limit setting", options=[create_option(name="limit", description="The limit of stars", option_type=SlashCommandOptionType.INTEGER, required=True, min_value=1, max_value=99)])
    @is_enabled()
